...
/* ./.libs/lt-mecab-cost-train.c - temporary wrapper executable for .libs/mecab-cost-train
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The mecab-cost-train program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "mecab-cost-train"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# mecab-cost-train - temporary wrapper script for .libs/mecab-cost-train\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The mecab-cost-train program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"mecab-cost-train:mecab-cost-train:${LINENO}: libtool wrapper (GNU lib", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"mecab-cost-train:mecab-cost-train:${LINENO}: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"mecab-cost-train:mecab-cost-train:${LINENO}: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='mecab-cost-train'\n", f);
