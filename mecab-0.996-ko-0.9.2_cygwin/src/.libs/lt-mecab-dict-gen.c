...
/* ./.libs/lt-mecab-dict-gen.c - temporary wrapper executable for .libs/mecab-dict-gen
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The mecab-dict-gen program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "mecab-dict-gen"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# mecab-dict-gen - temporary wrapper script for .libs/mecab-dict-gen\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The mecab-dict-gen program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"mecab-dict-gen:mecab-dict-gen:${LINENO}: libtool wrapper (GNU libtool", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"mecab-dict-gen:mecab-dict-gen:${LINENO}: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"mecab-dict-gen:mecab-dict-gen:${LINENO}: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
