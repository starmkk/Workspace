...
/* ./.libs/lt-mecab-system-eval.c - temporary wrapper executable for .libs/mecab-system-eval
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The mecab-system-eval program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/work/mecab/mecab-0.996-ko-0.9.2/src/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/work/mecab/mecab-0.996-ko-0.9.2/src/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "mecab-system-eval"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# mecab-system-eval - temporary wrapper script for .libs/mecab-system-eval\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The mecab-system-eval program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("  notinst_deplibs=' libmecab.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"mecab-system-eval:mecab-system-eval:${LINENO}: libtool wrapper (GNU l", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"mecab-system-eval:mecab-system-eval:${LINENO}: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"mecab-system-eval:mecab-system-eval:${LINENO}: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='mecab-system-eval'\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/work/mecab/mecab-0.996-ko-0.9.2/src/.libs:/usr/local/lib:/", f);
  fputs ("usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/work/mecab/mecab-0.996-ko-0.9.2/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
