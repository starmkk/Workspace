...
/* ./.libs/lt-mecab-test-gen.c - temporary wrapper executable for .libs/mecab-test-gen
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The mecab-test-gen program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "mecab-test-gen"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# mecab-test-gen - temporary wrapper script for .libs/mecab-test-gen\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The mecab-test-gen program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"mecab-test-gen:mecab-test-gen:${LINENO}: libtool wrapper (GNU libtool", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"mecab-test-gen:mecab-test-gen:${LINENO}: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"mecab-test-gen:mecab-test-gen:${LINENO}: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
