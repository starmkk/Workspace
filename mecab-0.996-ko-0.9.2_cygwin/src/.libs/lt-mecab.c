...
/* ./.libs/lt-mecab.c - temporary wrapper executable for .libs/mecab
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The mecab program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "mecab"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# mecab - temporary wrapper script for .libs/mecab\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The mecab program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"mecab:mecab:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian-2.4", f);
  fputs (".2-1ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"mecab:mecab:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"mecab:mecab:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
